...
// ========== Customer関連型定義（Company型と合わせて使用） ==========
export type Customer = Company; // CustomerはCompanyのエイリアス

export type CustomerStatus = CompanyStatus; // StatusもCompanyStatusのエイリアス

export interface CreateCustomerRequest extends CompanyCreate {}

export interface UpdateCustomerRequest extends CompanyUpdate {}

export interface SearchCustomersRequest extends CompanySearchRequest {}
